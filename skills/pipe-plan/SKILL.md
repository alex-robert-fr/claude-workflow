---
name: pipe-plan
description: Co-construire le plan d'un ticket (Jira, GitHub, GitLab, Gitea) par questions/réponses, et tenir le pilotage.
disable-model-invocation: true
argument-hint: [clé JIRA, numéro issue, URL ou texte]
allowed-tools:
