...
#
# stop_hook_active protege de la boucle infinie : si Claude a déjà ete relance par
...
# La sortie est capturee pour être renvoyee sur stderr en cas d'echec : c'est le
