...
La Pull Request tire son contexte du pilotage, sinon de l'identifiant present dans le nom de branche. Son corps liste les titres des commits : c'est le sommaire, le detail restant dans chaque commit.
...
- **Dependants** : [`changelog-et-release.md`](changelog-et-release.md), qui associe les commits a leurs Pull Requests
